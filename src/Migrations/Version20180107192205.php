 ...
 */
class Version20180107192205 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE description description LONGTEXT NOT NULL COLLATE utf8_unicode_ci');
    }
}
